    ...
    def parse(self,response):
        ...
        for eachMoive in Movies:
            ...
            if quote:
                ...
                quote=''
            print('fullTitle',unicode(fullTitle))
            print('movieInfo', unicode(movieInfo))
            print('star', unicode(star))
            print('quote', unicode(quote))
